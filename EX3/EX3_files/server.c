...
//    char response[1024];
    ...
    if(strcmp(filename,"302.txt")==0){
        const char *status = "302";
        const char *phrase = "Bad Request";
        const char *connection = "close";
        const char * html = "<HTML><HEAD><TITLE>302 Found</TITLE></HEAD>\n"
        ...
        sprintf(response,
                ...
                "Connection: %s\r\n"
                "\r\n",
                version, status, phrase,    // First line: version, status, phrase
    ...
    if(strcmp(filename,"400.txt")==0){
        ...
        const char *phrase = "Bad Request";
        const char *connection = "close";
        const char * html = "<HTML><HEAD><TITLE>400 Bad Request</TITLE></HEAD>\n"
    ...
    if(strcmp(filename,"403.txt")==0){
        const char *status = "403";
        const char *phrase = "403 Forbidden";
        const char *connection = "close";
        const char * html = "<HTML><HEAD><TITLE>403 Forbidden</TITLE></HEAD>\n"
    ...
    if(strcmp(filename,"404.txt")==0){
        const char *status = "404";
        const char *phrase = "404 Not Found";
        const char *connection = "close";
        const char * html = "<HTML><HEAD><TITLE>404 Not Found</TITLE></HEAD>\n"
    ...
    if(strcmp(filename,"500.txt")==0){
        ...
        const char *phrase = "500 Internal Server Error";
        const char *connection = "close";
        const char * html = "<HTML><HEAD><TITLE>500 Internal Server Error</TITLE></HEAD>\n"
    ...
    if(strcmp(filename,"501.txt")==0){
        ...
        const char *phrase = "Not supported";
        const char *connection = "close";
    ...
    if(strcmp(filename,"dir_content.txt")==0){
        ...
        const char *connection = "close";
        const char * html = "<HTML><HEAD><TITLE>501 Not supported</TITLE></HEAD>\n"
...
int main(int argc, char* argv[]) {
    if (argc != 5) {
        fprintf(stderr, "Usage: %s <port> <pool-size> <max-queue-size> <max-number-of-request>\n", argv[0]);
        exit(EXIT_FAILURE);
    }
